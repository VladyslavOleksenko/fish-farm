<template>
  ...
  <svg v-else-if="iconName === 'back'" :fill="pathColor"
  ...
  <svg v-else-if="iconName === 'statistics'" :fill="pathColor"
       xmlns="http://www.w3.org/2000/svg" id="Outline" viewBox="0 0 24 24"
       width="512" height="512">
    <path
  ...
  <svg v-else-if="iconName === 'time'" :fill="pathColor"
       id="Layer_1" height="512" viewBox="0 0 24 24" width="512"
       xmlns="http://www.w3.org/2000/svg" data-name="Layer 1">
    <path
